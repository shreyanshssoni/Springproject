	/*
	 * AdminVibes - Bootstrap 4 Design Admin Template
	 * @version v1.0 - Initial release
	 * @link http://coffeelabs.io
	 * Copyright (c) 2017 CoffeeLabs All rights reserved
	 */
	// Animation styles:
	'use strict';
	$(function() {
	  ...
	  // Hide elements first
	  $(".app-header .navbar ml-auto > li i, .breadcrumb, .card, .col-sm-4")
	    .css('opacity', 0);
	...
	/* fa-chevron-right icon homepage animation Test
		$('.fa-chevron-right').on('click', function (e) {
			e.preventDefault();

			$('.collapse').velocity('transition.slideUpOut', {
				stagger: 400,
				backwards: true
			})
		    .velocity({ opacity: 0 }, {
